...
describe("StatsView", () => {
	...
	it("sends getUsageStats message when refresh button is clicked", async () => {
		...
		const refreshButton = document.querySelector('[data-testid="stats-refresh-button"]') as HTMLButtonElement
	...
	it("disables export and clear buttons when no data exists", async () => {
		...
		const exportJson = document.querySelector('[data-testid="stats-export-json"]') as HTMLButtonElement
		const exportCsv = document.querySelector('[data-testid="stats-export-csv"]') as HTMLButtonElement
		const clearButton = document.querySelector('[data-testid="stats-clear-button"]') as HTMLButtonElement
	...
	it("closes clear dialog when cancel button is clicked", async () => {
		...
		const cancelButton = document.querySelector('[data-testid="stats-clear-cancel"]') as HTMLButtonElement
	...
	it("sends getUsageStats with preset 'today' when today range is clicked", async () => {
		...
		const rangeToday = document.querySelector('[data-testid="stats-range-today"]') as HTMLButtonElement
