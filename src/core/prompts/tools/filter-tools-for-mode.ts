...
export function filterNativeToolsForMode(
	...
	// Fall back to the mode config's own allowlist when the caller omits the parameter.
 ...
 */
function hasAnyMcpResources(mcpHub: McpHub, allowedMcpServers?: string[]): boolean {
