...
describe("getEnvironmentDetails", () => {
	...
	beforeEach(() => {
		...
		;(Terminal.compressTerminalOutput as Mock).mockImplementation(function (output: string) {
			return output
		})
	...
	it("should include inactive terminals with output", async () => {
		...
		;(TerminalRegistry.getTerminals as Mock).mockImplementation(function (active: boolean) {
