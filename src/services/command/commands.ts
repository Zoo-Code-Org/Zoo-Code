...
import { resolveGlobalConfigDirectory, resolveProjectConfigDirectoryForCwd } from "../roo-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join((await resolveGlobalConfigDirectory()).activePath, "commands")
	...
	const projectDir = path.join((await resolveProjectConfigDirectoryForCwd(cwd)).activePath, "commands")
