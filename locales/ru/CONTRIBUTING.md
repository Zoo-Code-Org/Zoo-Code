...
- Самостоятельно протестировать изменение там, где это практически возможно.
- Убедиться, что сгенерированный код правильный, необходимый и совместимый с лицензией проекта.
- Раскрыть существенную помощь ИИ в описании PR, когда она внесла материальный вклад в код, тесты или дизайн.
