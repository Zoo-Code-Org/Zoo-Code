...
## Что нового в v3.84.0

- ✨ **Добавлены новые SOTA-модели:** Используйте GPT-6 Sol, GPT-6 Luna и Claude Opus 5.5 у поддерживаемых провайдеров.
- 🧭 **Более надёжные задачи и подзадачи:** Сохраняйте изоляцию делегированных режимов, связи с подзадачами после повторных остановок и настройки оркестратора при переключении режима slash-командами.
- 🛠️ **Более надёжная работа терминала, провайдеров и поиска по коду:** Улучшена работа терминала в Windows и неанглоязычных средах, ответы и отмена запросов провайдеров, а поиск по коду теперь стабильнее использует правильный workspace.
