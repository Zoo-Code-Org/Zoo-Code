...
維護者可以關閉不完整、範圍過廣、不活躍、與專案方向不符或產生不相稱的審查或維護負擔的 PR。關閉 PR 不是對貢獻者的評判；這意味著該變更目前以其現有形式不可合併。
...
- 當 AI 對程式碼、測試或設計有實質性貢獻時，在 PR 說明中揭露重要的 AI 輔助情況。

請勿提交您不理解、未經測試或無法在審查過程中維護的 AI 生成變更。維護者可能會關閉看似主要由 AI 輔助但缺乏人工驗證、明確理由或審查跟進的 PR。
