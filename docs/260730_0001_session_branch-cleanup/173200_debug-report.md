...
**Consequence:** The remote series is _cleaner_ — it contains **no SHELL commits** and its
...
whole file with **2-space indentation** plus count syncs against an _older_ main. The
