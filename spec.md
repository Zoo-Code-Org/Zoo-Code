...
| Date       | Change                                                                                                                                         |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-15 | Corrected upstream license attribution guidance: Zoo Code/Roo Code are Apache 2.0; Kilo Code/OpenCode are MIT as currently published upstream. |
...
Upstream license notices require attribution and preservation. Maintain `ATTRIBUTIONS.md` listing upstream repos and their licenses: Zoo Code/Roo Code are Apache 2.0, while Kilo Code/OpenCode are MIT as currently published upstream. Do not remove upstream license headers from copied files; add Zoo Code copyright beneath them when modifying copied files where appropriate.
