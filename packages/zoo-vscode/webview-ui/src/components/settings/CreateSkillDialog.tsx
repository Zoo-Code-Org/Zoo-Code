...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@zoo-code/types"
...
/**
 * Validate skill name using shared validation from @zoo-code/types.
