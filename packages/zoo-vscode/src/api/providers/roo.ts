...
import { rooDefaultModelId, getApiProtocol, type ImageGenerationApiMethod } from "@zoo-code/types"
...
export class RooHandler extends BaseOpenAiCompatibleProvider<string> {
	...
	constructor(options: ApiHandlerOptions) {
		...
		let baseURL = process.env.ZOO_CODE_PROVIDER_URL ?? "https://api.roocode.com/proxy"
