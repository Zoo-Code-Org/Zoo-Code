...
const TIPS = [
	...
	"Use {highlight}zoo run{/highlight} for non-interactive scripting",
	"Use {highlight}zoo --continue{/highlight} to resume the last session",
	"Use {highlight}zoo run -f file.ts{/highlight} to attach files via CLI",
	"Use {highlight}--format json{/highlight} for machine-readable output in scripts",
	"Run {highlight}kilo serve{/highlight} for headless API access to Kilo",
	"Use {highlight}zoo run --attach{/highlight} to connect to a running server",
	"Run {highlight}zoo upgrade{/highlight} to update to the latest version",
