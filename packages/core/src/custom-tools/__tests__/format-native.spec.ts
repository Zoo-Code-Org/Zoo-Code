// pnpm --filter @zoo-code/core test src/custom-tools/__tests__/format-native.spec.ts

import { type SerializedCustomToolDefinition, parametersSchema as z, defineCustomTool } from "@zoo-code/types"
