...
export function generateRoomodesJsonSchema(): Record<string, unknown> {
	...
	jsonSchema["$id"] = "https://github.com/Zoo-Code-Org/Zoo-Code/blob/main/schemas/roomodes.json"
	jsonSchema["title"] = "Zoo Code Custom Modes"
	jsonSchema["description"] =
		"Schema for .roomodes configuration files supported by Zoo Code for legacy custom modes."
