import { readTaskSessionsFromStoragePath } from "@zoo-code/core/cli"
...
vi.mock("@zoo-code/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@zoo-code/core/cli")>()
	return {
		...actual,
