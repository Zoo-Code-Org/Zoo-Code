...
Maintainers may close PRs that are incomplete, too broad, inactive, not aligned with the project direction, or that create disproportionate review or maintenance burden. Closing a PR is not a judgment on the contributor; it means the change is not currently mergeable in its present form.
...
- Test the change yourself where practical.
- Verify that generated code is correct, necessary, and compatible with the project license.
- Disclose meaningful AI assistance in the PR description when it materially contributed to the code, tests, or design.

Please do not submit AI-generated changes that you do not understand, have not tested, or cannot maintain through review. Maintainers may close PRs that appear to be substantially AI-assisted but lack human verification, clear rationale, or review follow-through.
