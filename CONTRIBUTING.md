...
- Must reference an assigned GitHub Issue. To get assigned: comment "Claiming" on the issue reach out to the core team on [Discord](https://discord.gg/SfHYG44NUA). Assignment will be confirmed in the thread.
